...
import logoLotte from '@/images/logos/lotteLogo.svg'
    ...
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-6xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-5xl">
        ...
        <span className="relative whitespace-nowrap text-purple-600">
          ...
          <span className="relative"> 한국 경계를 넘어 일해보자!</span>
        </span>
        라는 의미를 담은 플랫폼으로, 베트남, 자카르타 등 글로벌하게 활동하는
        전문가들과 함께 협업할 수 있는 일자리를 창출합니다.
      </h1>
      <p className="mx-auto mt-6 max-w-6xl text-lg tracking-tight text-slate-700">
        사용자들은 퇴근 후 부수입 또는 장기 일자리를 확보하고, 기업은 적은
        비용으로 품질 높은 인력을 확보 해보세요!
      </p>
        ...
        >
          {[
            ...
            <li key={groupIndex}>
              ...
              >
                {group.map((company) => (
                  <li key={company.name} className="flex w-[200px]">
