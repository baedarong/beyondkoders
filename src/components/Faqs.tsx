  ...
  [
    {
      ...
      answer:
        '비욘드코더스의 매칭 알고리즘과 기업의 면접 및 선택을 통해 이루어지는 매칭 프로세스에서 발생하는 문제이기에 비욘드코더스 및 기업의 책임으로 간주합니다. 이 경우 보상 시스템을 통해 문제를 해결합니다.',
    },
    {
      question: '사용자가 업무를 완수하지 않은 채 그만둘 가능성이 무서워요.',
      answer:
        '위플젝(WePlject)을 통한 WBS Tracking과 형상관리시스템(GIT)을 활용하여 매일매일 진척율 체크할 수 있는 기능을 제공합니다. 특정 임계치 위반 시 계약위배로 패널티를 부과하니 안심하세요!',
    },
    {
      question:
